...
export default function Lobby({ user, room }: Props) {
  ...
  // This requests the list of boards from the backend. No cleanup necessary
  useEffect(() => {
    ...
    <div className={styles["Lobby"]}>
      ...
      {foundBoard ? (
        <div className={styles["invite-col"]}>
          <p className={styles["invite-blurb"]}>
            You have been invited to collaborate on this whiteboard. Choose an
            alias and you can join.
          </p>
          <button
            className={styles["enter-room"] + " btn-clr"}
